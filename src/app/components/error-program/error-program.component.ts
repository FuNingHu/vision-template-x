...
@Component({
    templateUrl: './error-program.component.html',
    styleUrls: ['./error-program.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    standalone: false
})

export class ErrorProgramComponent implements OnChanges, ProgramPresenter {
    ...
    @Input() contributedNode: ErrorProgramNode;

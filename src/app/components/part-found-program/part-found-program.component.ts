...
@Component({
    templateUrl: './part-found-program.component.html',
    styleUrls: ['./part-found-program.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    standalone: false
})

export class PartFoundProgramComponent implements OnChanges, ProgramPresenter {
    ...
    @Input() contributedNode: PartFoundProgramNode;
